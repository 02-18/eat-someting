  ...
  <div class="container">
    <div class="div-first">
      <div class="left-div">
        <el-upload
          ...
          action="http://localhost:40010/api/eat/upload/picture"
      ...
      <div class="right-div">
        ...
        <div style="width: 600px; margin: 10px auto">
          <el-button type="primary" style="width: 100%" @click="addFoodMenu"
            >Generate recipe</el-button
          >
        </div>
      </div>
    </div>
    <div class="div-second">
      <el-checkbox-group @change="getCheckList" v-model="checkList">
        ...
        >
          <el-checkbox
            style="width: 200px; margin-left: 10px; margin-top: 50px"
            :label="item.id"
